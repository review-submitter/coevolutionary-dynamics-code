...
def run_simulation(params,m, std_dev, ancestor_prey_growth,
    ...
    prey_laplace_coefficent = prey_std_dev / np.sqrt(2)
    
    # TODO: need to be confirmed!!!
    predator_std_dev = std_dev * ancestor_predator_capacity
    predator_laplace_coefficent = predator_std_dev / np.sqrt(2)
    ...
    while t <= max_time:
        ...
        if len(current_prey) == 0:
            ...
            if reaction_series_index == 0:
                ...
                current_prey[reaction_index].prey_mutation(cf.sample_truncated_laplace, current_prey, current_prey[reaction_index].g_value, prey_laplace_coefficent, 0, 1.0)
                ...
                current_prey[reaction_index[0]].prey_die()
                current_predator[reaction_index[1]].predator_mutation(cf.sample_truncated_laplace, current_predator, current_predator[reaction_index[1]].k_value, predator_laplace_coefficent, 0, 0.3)
...
if __name__ == "__main__":
    ...
    output_path = '/your_path/truncated_laplace/m={}_omega={}/'.format(args[0], args[1])
